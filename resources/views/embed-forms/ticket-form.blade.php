                            ...
                            <div class="row">
                                ...
                                @foreach ($ticketFormFields as $item)
                                    ...
                                    @else
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label class="control-label @if($item->required == 1) required @endif">@lang('modules.tickets.'.$item->field_name)</label>
                                                <input type="text" id="{{ $item->field_name }}" name="{{ $item->field_name }}" class="form-control" >
                                            </div>
                                        </div>
                                    @endif
                                @endforeach
                                @if($global->ticket_form_google_captcha == 1  && $superadmin->google_captcha_version=="v2" && $superadmin->google_recaptcha_status)
