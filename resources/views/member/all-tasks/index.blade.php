...
<script>
    ...
    function showTable() {
        ...
        var url = '{!!  route('member.all-tasks.data', [':hideCompleted', ':projectId']) !!}?clientID='+clientID +'&assignedBY='+ assignedBY+'&assignedTo='+ assignedTo+'&status='+ status+'&billable='+billable+'&_token={{ csrf_token() }}';
