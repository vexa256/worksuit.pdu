    <h4>@lang('app.menu.tasks') @lang('app.from') {{ $startDate }} <i class="ti-arrow-right"></i> {{ $endDate }}</h4>
                    ...
                    <h6 style="color: {{ $column->label_color }}">{{ ucwords($column->column_name) }}
                        ...
                        <div style="position: relative;" class="dropdown pull-right">
                            ...
                            <ul role="menu" class="dropdown-menu">
                                ...
                                @endif
                                @if($column->slug != 'completed' && $column->slug != 'incomplete' && $user->cans('delete_tasks'))
