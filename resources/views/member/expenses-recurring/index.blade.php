...
@section('page-title')
    <div class="row bg-title">
        ...
        <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12 text-right bg-title-right">
            <a href="{{ route('member.expenses-recurring.create') }}" class="btn btn-outline btn-success btn-sm">@lang('modules.expensesRecurring.addExpense') <i class="fa fa-plus" aria-hidden="true"></i></a>
