        ...
        <div class="col-xs-12">
            <div class="white-box">
                ...
                <div class="form-actions">
                    <button type="button" id="save-faq-category" onclick="saveFAQ();return false;" class="btn btn-success"> <i class="fa fa-check"></i> @lang('app.save')</button>
                </div>
                {!! Form::close() !!}
            </div>
        </div>
...
<script>
    ...
    myDropzone = new Dropzone("div#file-upload-dropzone", {
        url: "{{ route('admin.employee-faq.file-store') }}",
    ...
    myDropzone.on('completemultiple', function () {
        ...
        window.location.href = '{{ route('admin.employee-faq.index') }}'
    ...
    function saveFAQ() {
        var url = "{{ route('admin.employee-faq.store') }}";
        $.easyAjax({
            url: url,
