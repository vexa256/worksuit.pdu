...
<script src="{{ asset('plugins/bower_components/custom-select/custom-select.min.js') }}"></script>
    ...
    <script>
       var table = $('#contacts-table').dataTable({
        ...
        processing: true,
        serverSide: true,
        ajax: '{!! route('admin.project-notes.data', $project->id) !!}',
        deferRender: true,
        language: {
        ...
        columns: [
            ...
            $('#save-form').click(function () {
             ...
             $('body').on('click', '.edit-contact', function () {
                ...
                var url = '{{ route('admin.project-notes.edit', ':id')}}';
            ...
            $('body').on('click', '.view-contact', function () {
                ...
                var url = '{{ route('admin.project-notes.view', ':id')}}';
                url = url.replace(':id', id);
    ...
    $('body').on('click', '.sa-params', function(){
        ...
        swal({
            ...
            if (isConfirm) {
                var url = "{{ route('admin.project-notes.destroy',':id') }}";
                url = url.replace(':id', id);
