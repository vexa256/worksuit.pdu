        ...
        <div class="panel-body">
            ...
            <div class="form-body">
                <div class="row">
                    ...
                    <div class="col-md-3" id="duedateBox2">
                        <div class="form-group">
                            <label class="control-label required">@lang('app.dueDate')</label>
                            <input type="text" name="due_date" id="due_date2" class="form-control" autocomplete="off" value="@if($task->due_date != '' && $task->due_date != '-0001-11-30 00:00:00') {{ $task->due_date->format($global->date_format) }} @endif">
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group" style="padding-top: 25px;">
                            <div class="checkbox checkbox-info">
                                <input id="without_duedate2" @if($task->due_date == null) checked @endif  name="without_duedate" value="true"
                                       type="checkbox">
                                <label for="without_deadline2">@lang('modules.tasks.withoutDuedate')</label>
                            </div>
                        </div>
                    </div>
                    <!--/span-->
