                                                                        ...
                                                                        <div class="form-group">
                                                                            ...
                                                                            <select class="select2 form-control" data-placeholder="@lang('modules.tasks.chooseTask')" name="dependent_task_id" id="dependent_task_id" >
                                                                                ...
                                                                                @foreach($allTasks as $allTask)
                                                                                    <option value="{{ $allTask->id }}">{{ $allTask->heading }} (@lang('app.dueDate'): @if($allTask->due_date) {{ $allTask->due_date->format($global->date_format) }} @endif )</option>
                                                                                @endforeach
                                                                            </select>
                                                                        </div>
                                                                    </div>
                                                                ...
                                                                <div class="col-md-4">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input type="text" name="start_date" id="start_date" class="form-control"
                                                                               value="{{ \Carbon\Carbon::now($global->timezone)->format($global->date_format)  }}"
                                                                               autocomplete="off">
                                                                    </div>
                                                                </div>
                                                                <!--/span-->
