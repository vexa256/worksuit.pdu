<div class="modal-header">
    ...
    <h4 class="modal-title">@lang('modules.events.eventType')</h4>
</div>
...
<script>
    ...
    $('.delete-category').click(function () {
        ...
        var url = "{{ route('admin.events-type.destroy',':id') }}";
    ...
    $('#save-category').click(function () {
        $.easyAjax({
            url: '{{route('admin.events-type.store')}}',
