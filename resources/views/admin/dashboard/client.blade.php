...
<script>
    ...
    $('#save-form').click(function () {
        $.easyAjax({
            url: '{{route('admin.dashboard.widget', "admin-client-dashboard")}}',
    ...
    function loadData () {
            ...
            var url = '{{route('admin.clientDashboard')}}?startDate=' + encodeURIComponent(startDate) + '&endDate=' + encodeURIComponent(endDate);
