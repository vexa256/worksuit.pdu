                                ...
                                @if(in_array('projects', $modules))
                                    <div class="col-md-4">
                                        ...
                                        <div class="form-group" >
                                            ...
                                            <div class="row">
                                                <div class="col-xs-12">
                                                    <select class="select2 form-control" data-placeholder="Choose Project" id="project_id" name="project_id">
                                                        <option value="">--</option>
                                                    ...
                                                    <select class="form-control select2" name="client_id" id="client_id" data-style="form-control">
                                                        @foreach($clients as $client)
                                                            @if($client->id == $invoice->client_id)
                                                                <option value="{{ $client->id }}"  selected>{{ ucwords($client->name) }}
                            ...
                            <div class="row">
                                        ...
                                        <div class="col-xs-12 item-row margin-top-5">
                                            ...
                                            <div class="col-md-1">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" min="1" readonly class="form-control quantity"
                                ...
                                <div class="col-xs-12 ">
                                    ...
                                    <div class="row m-t-5 font-bold">
                                        ...
                                        <p class="form-control-static col-xs-6 col-md-2" >
                                            <span class="total">{{ number_format((float)$invoice->sub_total-($totalTax+$totalDiscount), 2, '.', '') }}</span>
                                        </p>
