...
<script src="{{ asset('plugins/bower_components/custom-select/custom-select.min.js') }}"></script>
    ...
    <script>
       var table = $('#contacts-table').dataTable({
        ...
        processing: true,
        serverSide: true,
        ajax: '{!! route('client.project-notes.data', $project->id) !!}',
        deferRender: true,
        language: {
        ...
        columns: [
            ...
            $('#save-form').click(function () {
                $.easyAjax({
                    url: '{{route('admin.project-notes.store')}}',
                    container: '#addNotes',
                    type: "POST",
                    redirect: true,
             ...
             $('body').on('click', '.view-contact', function () {
                ...
                var url = '{{ route('client.project-notes.verify-password', ':id')}}';
            ...
            $('body').on('click', '.view-notes-modal', function () {
                ...
                var url = '{{ route('client.project-notes.view', ':id')}}';
                url = url.replace(':id', id);
    ...
    $('body').on('click', '.sa-params', function(){
        ...
        swal({
            ...
            if (isConfirm) {
                var url = "{{ route('client.project-notes.destroy',':id') }}";
                url = url.replace(':id', id);
