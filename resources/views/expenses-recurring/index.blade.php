...
@section('page-title')
    <div class="row bg-title">
        ...
        <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12 text-right bg-title-right">
            <a href="{{ route('admin.expenses-recurring.create') }}" class="btn btn-outline btn-success btn-sm">@lang('modules.expenses.addExpense') <i class="fa fa-plus" aria-hidden="true"></i></a>
...
<script>
    ...
    $(function() {
        $('#expenses-recurring-table').on('preXhr.dt', function (e, settings, data) {
        ...
        $('body').on('click', '.delete-expense', function(){
            ...
            swal({
                ...
                if (isConfirm) {
                    ...
                    var url = "{{ route('admin.expenses-recurring.destroy',':id') }}";
                    ...
                    $.easyAjax({
                        ...
                        success: function (response) {
                            if (response.status == "success") {
                                $.unblockUI();
                                window.LaravelDataTables["expenses-recurring-table"].draw();
                            }
                        }
                    });
                }
    ...
    $(document).on('click', '.view-expense', function () {
        var id = $(this).data('expense-id');
        var url = "{{ route('admin.expenses-recurring.show',':id') }}";
        url = url.replace(':id', id);
    ...
    $(document).on('click', '.change-status', function () {
        var url = "{{route('admin.expenses-recurring.changeStatus')}}";
        var token = "{{ csrf_token() }}";
        var id =  $(this).data('expense-id');
