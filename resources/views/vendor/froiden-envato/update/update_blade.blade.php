...
<div class="col-xs-12" id="support-div">
    ...
    <div class="col-md-12 alert alert-info">
        ...
        @if(\Carbon\Carbon::parse($envatoUpdateCompanySetting->supported_until)->diffInDays() < 30) <div
...
<div class="alert alert-info col-md-12">
    ...
    <div class="col-md-3 text-center">
        <a id="update-app" href="javascript:;" class="btn btn-success btn-small">@lang('modules.update.updateNow') <i
