$(document).ready(function () {
    ...
    $(function () {
        ...
        // when expenses-recurring active then expenses was also show active for prevent that include this script.
        if(url.href.indexOf('expenses-recurring') != -1){
            var expUrl = document.location.origin+'/admin/finance/expenses';
            var expmemberUrl = document.location.origin+'/member/finance/expenses';
            $("a[href='"+expUrl+"']").removeClass("active");
            $("a[href='"+expmemberUrl+"']").removeClass("active");
        }
    });
