        ...
        return DataTables::of($milestones)
            ->addColumn('action', function ($row) {
                return '<a href="javascript:;" class="btn btn-info btn-circle edit-milestone"
                        ...
                        <a href="javascript:;" class="btn btn-primary btn-circle milestone-detail"
                        data-toggle="tooltip" data-milestone-id="' . $row->id . '" data-original-title="' . __('app.view') . '"><i class="fa fa-search" aria-hidden="true"></i></a>
            ...
            ->editColumn('milestone_title', function ($row) {
                return ucfirst($row->milestone_title) ;
            })
