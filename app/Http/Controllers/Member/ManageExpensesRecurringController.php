...
use App\Currency;
use App\DataTables\Member\ExpensesDataTable;
use App\DataTables\Member\ExpensesRecurringDataTable;
use App\DataTables\Member\RecurringExpensesDataTable;
...
class ManageExpensesRecurringController extends MemberBaseController
{
    ...
    public function index(ExpensesRecurringDataTable $dataTable)
    {
        ...
        return $dataTable->render('member.expenses-recurring.index', $this->data);
    }
    ...
    public function recurringExpenses(RecurringExpensesDataTable $dataTable, $id)
    {
        ...
        return $dataTable->render('member.expenses-recurring.recurring-expenses', $this->data);
    }
    ...
    public function create()
    {
        ...
        return view('member.expenses-recurring.create', $this->data);
    }
    ...
    public function store(StoreRecurringExpense $request)
    {
        ...
        return Reply::redirect(route('member.expenses-recurring.index'), __('messages.expenseSuccess'));
    }
    ...
    public function edit($id)
    {
        ...
        $this->employees = $employees;
        return view('member.expenses-recurring.edit', $this->data);
    }
    ...
    public function update(StoreRecurringExpense $request, $id)
    {
        ...
        return Reply::redirect(route('member.expenses-recurring.index'), __('messages.expenseUpdateSuccess'));
    }
    ...
    public function show($id)
    {
        ...
        return view('member.expenses-recurring.show', $this->data);
    }
