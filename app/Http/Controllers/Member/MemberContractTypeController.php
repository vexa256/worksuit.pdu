...
class MemberContractTypeController extends MemberBaseController
{
    ...
    public function index() {
        $this->pageIcon = '';
        $this->pageTitle = 'app.menu.contracts';
        return view('member.contract-type.index', $this->data);
    }
    ...
    public function create() {
        ...
        return view('member.contract-type.create-modal');
    }
    public function createContractType()
    {
        $this->contractType = ContractType::all();
        return view('member.contracts.create-contract-type', $this->data);
    }
    ...
    public function edit($id) {
        ...
        return view('member.contract-type.edit', $this->data);
    }
