...
class EstimatesDataTable extends BaseDataTable
{
    ...
    public function query(Estimate $model)
    {
        ...
        $model = $model->join('client_details', 'estimates.client_id', '=', 'client_details.user_id')
            ...
            ->select('estimates.id', 'estimates.client_id', 'client_details.name', 'estimates.total', 'currencies.currency_symbol', 'estimates.status', 'estimates.valid_till', 'estimates.estimate_number', 'estimates.send_status');
