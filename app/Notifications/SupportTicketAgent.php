...
class SupportTicketAgent extends BaseNotification
{
    ...
    public function toMail($notifiable)
    {
        return (new MailMessage)
            ->subject(__('email.supportTicketAgent.subject') . ' - ' . config('app.name'))
            ->greeting(__('email.hello') . ' ' . ucwords($notifiable->name) . '!')
            ->line(__('email.supportTicketAgent.text'))
    ...
    public function toOneSignal($notifiable)
    {
        return OneSignalMessage::create()
            ->subject(__('email.supportTicketAgent.subject'))
            ->body(__('email.supportTicketAgent.text'));
    }
}
